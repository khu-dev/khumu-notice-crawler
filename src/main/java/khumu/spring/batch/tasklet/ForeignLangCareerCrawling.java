...
public class ForeignLangCareerCrawling implements Tasklet, StepExecutionListener {
    ...
    public void beforeStep(StepExecution stepExecution) {
        ...
        Author author = Author.builder()
                .id(11L)
                .authorName("외국어대학취업공지").build();
        authorRepository.save(author);

        Board board = Board.builder()
                .id(11L)
                .frontUrl("http://foreign.khu.ac.kr/contents/bbs/bbs_list.html?bbs_cls_cd=002004010")
                .backUrl(null)
                .lastId(null)
                .author(author).build();
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        Author target = authorRepository.findByAuthorName("외국어대학취업공지").get();
