...
public class CsCommonCrawling implements Tasklet, StepExecutionListener {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        Author target = authorRepository.findByAuthorName("컴퓨터공학과일반공지").get();
