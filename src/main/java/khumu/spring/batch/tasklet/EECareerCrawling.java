...
public class EECareerCrawling implements Tasklet, StepExecutionListener {
    ...
    public void beforeStep(StepExecution stepExecution) {
        ...
        Author author = Author.builder()
                .id(7L)
                .authorName("전자공학과취업공지").build();
        authorRepository.save(author);

        Board board = Board.builder()
                .id(7L)
                .frontUrl("https://ee.khu.ac.kr/ee/user/bbs/BMSR00040/list.do?menuNo=1900038")
                .backUrl(null)
                .lastId(null)
                .author(author).build();
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        Author target = authorRepository.findByAuthorName("전자공학과취업공지").get();
